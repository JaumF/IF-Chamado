...
urlpatterns = [
    ...
    path('reabrir_chamado/<int:pk>/', views.reabrir_chamado, name='reabrir_chamado'),
    path('chamado_reaberto/<int:chamado_id>/', views.chamado_reaberto, name='chamado_reaberto'),
]
